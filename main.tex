...
%% Use standard page style
% \pagestyle{short}
\input{base/history.tex}
...
%% Validation
\appendix
\chapter{Validación de requisitos}\label{sec:validation}
\input{content/appendix/validation.tex}
\chapter{Diagramas que modelan el sistema}\label{sec:diagrams}
